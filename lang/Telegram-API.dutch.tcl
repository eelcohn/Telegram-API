# ---------------------------------------------------------------------------- #
# Telegram-API module for Eggdrop - Dutch language file v20180119              #
#                                                                              #
...
set MSG_TG_USERJOINED		"%1\$s@Telegram is nu lid van de Telegram groep."
set MSG_TG_USERADD		"%1\$s@Telegram heeft %2\$s aan de Telegram groep toegevoegd."
set MSG_TG_USERLEFT		"%1\$s@Telegram heeft de Telegram groep verlaten."
set MSG_TG_USERREMOVED		"%1\$s@Telegram heeft %2\$s uit de Telegram groep verwijderd."
