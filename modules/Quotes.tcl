# ---------------------------------------------------------------------------- #
# Telegram-API Quote module v0.1 for Eggdrop v20171216                         #
#                                                                              #
...
#						putquick "PRIVMSG $channel :Quote \002$quote_id\002 of \002[expr $quote_count + 1]:\002 $qot_sel"
	...
	libtelegram::sendMessage $chat_id $msgid "markdown" "[escape_out_bracket $qot_sel]"
...
proc quotes_addQuote {chat_id msgid channel message parameter_start} {
	...
	if {$quote ne ""} {
		...
		libtelegram::sendMessage $chat_id $msgid "markdown" $MSG_QUOTE_QUOTEADDED
