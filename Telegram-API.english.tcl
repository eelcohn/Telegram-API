...
set MSG_IRC_TOPICCHANGE		"<i>%s@IRC</i> has changed the topic on <a href=\"%s\">%s</a> to <i>%4\$s</i>"
...
set MSG_TG_AUDIOSENT		"\026%s@Telegram has sent an audiofile: %s - %s (%s s). Use \026/dccget %s tgfile %s \026to download the file."
set MSG_TG_DOCSENT			"\026%s@Telegram has sent a document: %s (%s bytes).  Use \026/dccget %s tgfile %s \026to download the file."
set MSG_TG_PHOTOSENT		"\026%s@Telegram has sent a photo%s. Use \026/dccget %s tgfile %s \026to download the file."
set MSG_TG_STICKERSENT		"\026%s@Telegram has sent a sticker (%s).\026"
set MSG_TG_VIDEOSENT		"\026%s@Telegram has sent a video%s (%s s). Use \026/dccget %s tgfile %s \026to download the file."
set MSG_TG_VOICESENT		"\026%s@Telegram has sent a voice file: %s (%s bytes). Use \026/dccget %s tgfile %s \026to download the file."
...
set MSG_TG_PICCHANGE		"\026%s@Telegram has changed the Telegram group picture. Use \026/dccget %s tgfile %s \026to download the file."
...
set MSG_QUOTE_HELP			"Use <i>/addquote</i> to add a quote to the quote-list."
